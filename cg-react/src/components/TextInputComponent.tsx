  ...
  return (
    <div className="relative mb-6">
      <input
        ...
        id={name}
        name={name}
        className={`flex flex-col items-center w-80 h-8 border border-khakeshtari-400 px-4 py-2 rounded-2xl text-xs font-normal placeholder-gray font-isf pr-[30px] ${className} placeholder-start ${error ? "border-red-500" : ""}`}
        dir="rtl"
