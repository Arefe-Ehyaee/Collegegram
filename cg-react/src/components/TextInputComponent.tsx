...
const InputField :React.FC<InputProps>= ({ name, placeholder, type, onChange, styling, iconsrc }) => {
  ...
  return(
    ...
    <input
      ...
      name={name}
      id={name}
      className={`flex flex-col items-center w-80 h-12 border border-khakeshtari-400 px-4 py-2 rounded-2xl text-xs font-normal placeholder-gray font-isf  ${styling} placeholder-start`}
      dir="rtl"
